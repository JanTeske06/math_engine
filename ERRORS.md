...
This is a complete list of all error codes thrown by **math_engine**.
...
| **2003** | Logarithm result error:  |
| **2004** | Unable to identify given Operation:  |
| **2505** | Loading Configurations for degree setting. |
| **2706** | Process already running |
| **3000** | Missing Opening Bracket:  |
| **3001** | Missing Solver. |
| **3002** | Multiple Variables in problem:  |
| **3003** | Division by Zero |
| **3004** | Invalid Operator:  |
...
| **3009** | Missing ')'.  |
| **3010** | Missing '('.  |
| **3011** | Unexpected Token:  |
| **3012** | Invalid equation:   |
| **3013** | Infinit Solutions. |
| **3014** | No Solution |
| **3015** | Normal Calculator on Equation. |
| **3022** | One of the equation sides is empty |
| **3023** | Missing '()': |
